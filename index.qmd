...
# I. The <red>Problem</red> of Shape Reconstruction {background-image="drawing.png" background-opacity="0.3"}
...
## <green>Homological</green> Guarantees
...
# II. Reconstruction via <green>Vietoris--Rips Complexes</green> {background-image="drawing.png" background-opacity="0.3"}
...
# III. Beyond Manifolds {background-image="drawing.png" background-opacity="0.3"}
...
# IV. Geometric Reconstruction {background-image="drawing.png" background-opacity="0.3"}

# V. Future Directions {background-image="drawing.png" background-opacity="0.3"}
